...
export const UMKMBanner = () => {
    ...
    return (
        <div className="relative bg-white w-full h-screen mt-20 lg:h-[923px] lg:pb-52 pb-20 overflow-hidden">
            ...
            <div className="absolute bg-black bg-opacity-50 inset-0 flex flex-col justify-center items-center text-white p-4 md:p-8">
                <h2 className="text-2xl md:text-5xl font-bold text-center">UMKM</h2>
                <p className="text-lg md:text-2xl text-center">Usaha Usaha Mikro, Kecil, dan Menengah yang <br></br> Beroperasi di Lingkungan Kelurahan Tawangsari</p>
            </div>
        </div>
    );
}
