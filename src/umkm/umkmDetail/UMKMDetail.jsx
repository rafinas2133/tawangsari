...
export const UMKMDetail = () => {
    ...
    return (
      ...
      <div className="bg-card w-full text-white text-center py-4 mb-6">
          <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-20 sm:mt-24 md:mt-28">UMKM</h1>
      </div>
      <div className="flex flex-col md:flex-row gap-4 px-4 sm:px-8 md:px-12 lg:px-20">
          <div className="bg-white p-4 rounded-lg shadow-lg flex flex-col w-full md:w-2/3 items-center">
              <h2 className="text-xl sm:text-2xl font-bold mb-4">Pentol Bakso Cak Endro</h2>
              <div className="relative w-full">
                  <img
                      src="https://via.placeholder.com/600x400.png?text=Image+Placeholder"
                      alt="Pentol Bakso Cak Endro"
                      className="rounded-lg w-full h-48 sm:h-64 md:h-80 object-cover"
                  />
                  <button className="absolute top-1/2 left-2 sm:left-4 transform -translate-y-1/2 bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-full text-sm sm:text-base">
                      {"<"}
                  </button>
                  <button className="absolute top-1/2 right-2 sm:right-4 transform -translate-y-1/2 bg-gray-500 hover:bg-gray-700 text-white font-bold py-1 px-2 sm:py-2 sm:px-4 rounded-full text-sm sm:text-base">
                      {">"}
                  </button>
              </div>
