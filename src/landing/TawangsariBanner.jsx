...
export const TawangsariBanner = () => {
    ...
    return (<div
        className={`relative w-full min-h-[50vh]  md:h-[40vw] lg:h-[50vw] mt-20 h-max lg:pb-52 pb-20 overflow-hidden bg-cover`}
    ...
    >
        ...
        <div
            ...
            <img src={LogoBlitar ? LogoBlitar : ''} alt="Kelurahan Tawangsari" className="h-20 md:h-36 mb-4"/>
